...
// See below for an example using the filter method on the users array to 
// return a new array containing only the users under the age of 30. For 
...
// assign a new array of objects with only title and rating keys. The 
// new array should only include objects where imdbRating is greater 
// than or equal to 8.0. Note that the rating values are saved as strings 
// in the object and you may need to convert them into numbers to perform mathematical operations on them.
