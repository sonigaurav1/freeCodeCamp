...
//   in place. One way to avoid this is to first concatenate an empty
//    array to the one being sorted (remember that slice and concat
//      return a new array), then run the sort method.
