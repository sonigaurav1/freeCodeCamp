...
//   accept a function as a parameter to be able to change the type of tea 
//   it prepares. This makes getTea more flexible, and gives the programmer
...
//  other methods, for example in filter, the callback function tells JavaScript
//   the criteria for how to filter an array.

// Functions that can be assigned to a variable, passed into another function,
//  or returned from another function just like any other normal value, are 
//  called first class functions. In JavaScript, all functions are first class functions.

// The functions that take a function as an argument, or return a function as 
// a return value, are called higher order functions.
