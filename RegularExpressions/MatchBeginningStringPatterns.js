...
let firstString = "Ricky is first and can be found."; // Ricky first me ba ki na => ba tw true
let firstRegex = /^Ricky/;
firstRegex.test(firstString);
let notFirst = "You can't find Ricky now."; // Ricky first me ba ki na => na tw false || IF Ricky aage me likh dem tw true hojai
