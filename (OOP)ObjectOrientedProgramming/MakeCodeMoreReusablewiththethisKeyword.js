...
// code referencing the original name would need to be updated
//  as well. In a short object definition, it isn't a problem,
//   but if an object has many references to its properties there 
...
//  associated with: duck. If the object's name is changed to mallard, it 
//  is not necessary to find all the references to duck in the code. It
